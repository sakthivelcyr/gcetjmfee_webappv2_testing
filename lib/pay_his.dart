      ...
      body: Container(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              title(size, 'Payment History', context),
              Container(
                width: size.width,
          ...
          switch (snapshot.connectionState) {
            ...
            default:
              return new PaginatedDataTable(
                header: Text('Payment History', style: Style.headStyle),
                columns: [
                  getDataColumn('Sl.No.'),
                  ...
                  getDataColumn('Paid Date'),
                  getDataColumn('Pay By'),
                  getDataColumn('Time'),
                  getDataColumn('Transaction Id'),
                  getDataColumn('Transaction Reference'),
  ...
  DataRow getRow(int index) {
    return DataRow.byIndex(
      ...
      cells: [
        ...
        DataCell(
          d[index]['paidDate'] == null
              ? Text('No Data')
              : Text(d[index]['paidDate'], style: Style.cellStyle),
        ),
        DataCell(
          d[index]['payBy'] == null
              ? Text('No Data')
              : Text(d[index]['payBy'], style: Style.cellStyle),
        ),
        DataCell(
          d[index]['time'] == null
              ? Text('No Data')
              : Text(d[index]['time'], style: Style.cellStyle),
        ),
        DataCell(
          d[index]['txnId'] == null
              ? Text('No Data')
              : Text(d[index]['txnId'], style: Style.cellStyle),
        ),
        DataCell(
          d[index]['txnRef'] == null
              ? Text('No Data')
              : Text(d[index]['txnRef'], style: Style.cellStyle),
        ),
      ],
    );
  }
